...
const WEAPONS: CatalogItem[] = [
  // ── A 전설·정면 묘사 18 ───────────────────────────────────────────────
  {
    key: 'ridge_runescar_greatsword',
    slot: 'weapon',
    nameKo: '룬흉터 대검',
    region: '고대 룬 산맥',
    tone: '장엄',
    lore: '비탈에서 떨어진 한 조각을 두드려 편 대검이다. 표면을 가로지른 푸른 균열은 식지 않는다. 두드릴수록 금이 안으로 더 깊이 뭉치고, 칼날에 산울림이 한 번 더 얹힌다. 자루는 룬 가루에 묻혀 손바닥에 차다.',
    art: `ornate fantasy weapon: heavy two-handed greatsword, grey carved-stone blade with deep glowing-blue rune cracks, iron-bound stone grip, monumental, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'marsh_drywell_dagger',
    slot: 'weapon',
    nameKo: '마른 우물 단검',
    region: '늪지대',
    tone: '기괴',
    lore: '마른 우물 바닥에서 건진 단검 한 자루. 검붉은 녹이 날을 단단히 붙들어 닦이지 않는다. 손에 쥐면 늪 안개가 한 호흡 더 무거워지고, 자루 끝엔 새벽 등불 그을음이 짙다. 칼날이 옅게 끈끈하다.',
    art: `ornate fantasy weapon: short marsh dagger, deep red-rusted iron blade, swamp-soaked leather grip, faint cold mist, eerie, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'ashfall_halfcooled_blade',
    slot: 'weapon',
    nameKo: '식다 만 강철검',
    region: '서쪽 화산',
    tone: '비애',
    lore: '화로에서 마지막에 친 한손검이다. 칼날 한쪽이 식다 만 결로 그대로 굳어 있다. 손바닥에 옅게 따뜻하고, 그 따뜻함은 떨어지지 않는다. 자루를 감은 가죽엔 화로 그을음이 짙고, 칼끝엔 잿비 한 알이 박혀 있다.',
    art: `ornate fantasy weapon: one-handed sword with one side of the blade left raw grainy, half-cooled steel grain, ash-stained leather grip, warm sheen, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'fallen_feather_rapier',
    slot: 'weapon',
    nameKo: '깃 두른 레이피어',
    region: '타락천사',
    tone: '비애',
    lore: '검집에 검은 깃 한 가닥이 끼워져 있다. 뽑을 때마다 깃 스치는 소리가 들린다. 소리는 매번 한 호흡씩 짧아지고, 빈 신전에 차가운 빛이 한 번 더 길게 떨어진다. 칼날엔 깃털 한 결이 옅게 묻는다.',
    art: `ornate fantasy weapon: slim rapier, pale silver blade, single black feather wedged into the sheath near the guard, white cloth grip, mournful, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'orchard_harvest_scythe',
    slot: 'weapon',
    nameKo: '들녘 큰낫',
    region: '일반',
    tone: '일상',
    lore: '추수 들녘에 묶여 세워진 큰낫. 자루엔 그해 빌려 쓴 사람 수가 한 줄씩 새겨진다. 올해는 다섯 줄째이고, 칼날엔 마른 풀이 아직 묻어 있다. 새벽이슬에 한 줄 더 그을 자국이 남고, 자루 끝엔 빗자국이 두 개 둥글다.',
    art: `ornate fantasy weapon: long two-handed harvest scythe, curved iron blade with grass stains, ash shaft with five carved tally lines, hemp-wrapped grip, homely autumn mood, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'tusk_signal_hatchet',
    slot: 'weapon',
    nameKo: '어금니 손도끼',
    region: '오크 부락',
    tone: '위트',
    lore: '부락 흥정터에서 가장 안 팔리던 도끼다. 자루에 어금니 두 개가 박혀 있는데, 진짜 누구 것이냐고 물으면 답이 매번 달랐다. 지금은 신참 전사가 차고 다니며 흥정터를 휘젓고 있다. 어금니가 천막 줄에 부딪쳐 소리가 한 번 더 난다.',
    art: `ornate fantasy weapon: stout one-handed hatchet, chipped iron head, hide-strap haft, two large tusks driven into the handle, rugged tribal pride, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'caravan_road_falchion',
    slot: 'weapon',
    nameKo: '겨울길 짧은검',
    region: '일반',
    tone: '영웅담',
    lore: '겨울 산모퉁이를 마지막까지 넘은 수레의 짧은검이다. 칼등엔 도적 셋을 멈춰 세운 흠집이 한 줄로 깊다. 짐꾼은 그 흠집을 자랑하지 않았고, 자루는 무릎 위에서 닳아 매끈하다. 칼집엔 눈 자국이 한 줄 박혀 있다.',
    art: `ornate fantasy weapon: short curved falchion, dull steel blade with one long deep scar down the spine, leather grip darkened by years, road-worn pride, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'reed_cutter_billhook',
    slot: 'weapon',
    nameKo: '갈대 베는 갈고리낫',
    region: '늪지대',
    tone: '담백',
    lore: '늪 어귀에 세워진 짧은 갈고리낫. 갈대 짜는 노파가 평생 베어 온 자루는 손바닥 자국으로 매끈하다. 새벽 안개가 그 자루에 한 번 더 내려앉고, 칼날 끝엔 갈대 즙이 옅게 굳어 있다. 등불 빛이 칼등을 한 번 더 스친다.',
    art: `ornate fantasy weapon: short billhook with hooked iron blade, marsh-grass stains, reed-wrapped wooden haft polished by palm wear, calm dawn mist, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'stone_quaker_maul',
    slot: 'weapon',
    nameKo: '산 흔드는 망치',
    region: '고대 룬 산맥',
    tone: '장엄',
    lore: '룬 산맥 산문 옆에 세워진 큰망치. 머리엔 다시 뭉친 돌가루가 한 겹 굳어 있다. 한 번 휘두를 때마다 산울림이 두 번 돌아오고, 푸른 균열 사이로 빛이 한 번 더 새 나온다. 자루 끝엔 측량가의 표시가 한 줄 깊다.',
    art: `ornate fantasy weapon: heavy two-handed warmaul, grey carved-stone head with crusted stone-dust, iron-bound haft with faint glowing-blue cracks, monumental, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'forge_test_glaive',
    slot: 'weapon',
    nameKo: '화로 시험 글레이브',
    region: '서쪽 화산',
    tone: '영웅담',
    lore: '시험에 나선 자가 잿비를 뚫고 산을 한 바퀴 돌아 내려온 긴 칼날 창. 칼날엔 그날의 그을음이 새카맣게 남아 있다. 자루는 짚고 내려온 자국이 깊고, 화로 으르렁대는 소리가 칼끝에 묻어 있다. 칼날 등엔 시험 표시 일곱이 줄을 섰다.',
    art: `ornate fantasy weapon: long glaive polearm, single curved blade deeply soot-blackened, charred ash shaft with deep grip wear from leaning, heroic worn, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'bog_lantern_gaff',
    slot: 'weapon',
    nameKo: '늪 등불 갈고리',
    region: '늪지대',
    tone: '기괴',
    lore: '등불 옆에 늘 세워진 긴 갈고리. 끝엔 본 적 없는 매듭이 한 번 묶여 있다. 풀려고 손을 대면 안개가 한 호흡 더 무거워지고, 매듭은 처음 묶인 모양 그대로 돌아간다. 갈고리 살엔 끈끈한 늪 물풀이 한 줄 감겨 있다.',
    art: `ornate fantasy weapon: long fishing gaff polearm, rusted hook head, reed-wrapped pole, strange knot lashed near the head, lantern soot, eerie marsh feel, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'tribal_share_axe',
    slot: 'weapon',
    nameKo: '노획 나누는 큰도끼',
    region: '오크 부락',
    tone: '장엄',
    lore: '분배인이 들고 다닌 큰도끼. 도끼날 등엔 한 번 나눌 때마다 한 줄 새긴 홈이 빽빽하다. 자루까지 닿은 줄 위로 새 홈 하나가 더 들어서고, 모닥불 연기가 그 위로 한 번 더 깔린다. 자루 끝엔 족장의 표식이 깊다.',
    art: `ornate fantasy weapon: large two-hand orc axe, broad iron blade with dense rows of small share-tally notches along the spine, leather-bound haft, tribal weight, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'broken_halo_arming_sword',
    slot: 'weapon',
    nameKo: '깨진 후광 한손검',
    region: '타락천사',
    tone: '장엄',
    lore: '깨진 후광 조각을 자루 끝에 둥글게 박아 만든 한손검. 후광은 차게 식어 있어 쥔 손이 손목까지 잠시 차다. 빈 신전 가운데에 똑바로 서 있고, 그 옆엔 흰 천 한 자락이 떨어져 있다. 칼날엔 차가운 빛이 한 줄 비친다.',
    art: `ornate fantasy weapon: one-handed arming sword, pale silver blade, broken halo fragment forming a small ring at the pommel, white-cloth grip, solemn cold sheen, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'butcher_evening_cleaver',
    slot: 'weapon',
    nameKo: '저녁 장터 큰 식칼',
    region: '일반',
    tone: '일상',
    lore: '장터 막바지에 도마 위에 비스듬히 세워진 큰 식칼. 한쪽 날이 닳아 한 점을 늘 더 두툼하게 친다. 사람들은 그 두께 때문에 줄을 섰고, 도마엔 비뚜름한 칼자국이 가지런하다. 자루엔 기름때가 한 결씩 쌓였다.',
    art: `ornate fantasy weapon: heavy butcher cleaver, slightly worn lopsided edge, smoke-stained wooden handle with hemp wrap, friendly market feel, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    ...
    region: '서쪽 화산',
    tone: '기괴',
    lore: '끓는 강 어귀에서 건진 굽이굽이 물결무늬 단검. 칼날에 비친 그림자가 굽이를 따라 한 번 휘청 휜다. 다시 들여다보면 그대로이고, 자루엔 잿비가 한 알씩 들이친 자국이 박혀 있다. 칼끝엔 강의 김이 한 줄 서린다.',
  ...
  {
    key: 'attic_dustblade_sabre',
    slot: 'weapon',
    nameKo: '다락의 사브르',
    region: '일반',
    tone: '수수께끼',
    lore: '집안 다락 구석에 놓인 사브르 한 자루. 자루엔 이름이 새겨질 자리가 비었다. 다락엔 햇빛이 길게 떨어지고, 칼날 위로 먼지가 한 결씩 가지런히 쌓인다. 칼집엔 옛 군복의 천 조각이 한 자락 끼워져 있다.',
    art: `ornate fantasy weapon: curved sabre, polished but dust-worn steel, leather grip with one blank engraved nameplate, attic shadow mood, gentle mystery, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'graveyard_shovelblade',
    slot: 'weapon',
    nameKo: '묘지기 삽 칼',
    region: '일반',
    tone: '기괴',
    lore: '한쪽 면을 갈아 칼날처럼 만든 짧은 삽. 자루 안쪽 옹이엔 묘지기의 손바닥 자국이 깊다. 자루를 들면 흙냄새가 손목까지 올라오고, 삽날 끝엔 새벽 서리가 한 줄 굳어 있다. 옹이엔 작은 글자 하나가 옅게 눌려 있다.',
  ...
  {
    key: 'midwife_belt_blade',
    slot: 'weapon',
    nameKo: '산파의 짧은 칼',
    region: '일반',
    tone: '영웅담',
    lore: '눈보라 새벽에 두 마을 사이 얼어붙은 개울을 입에 물고 건넌 짧은 칼. 자루엔 매듭이 일곱 묶여 있다. 첫 울음 한 번에 매듭 하나, 칼날엔 새벽 김이 한 번 더 서린다. 칼집엔 산모의 천 조각이 옅게 묶여 있다.',
    art: `ornate fantasy weapon: small short blade, gently rounded tip, smooth grip with seven small braided knots along the handle, brave humble feel, crafted equippable weapon game asset, ${STYLE}`,
  },

  // ── E 1인칭 일기 8 ────────────────────────────────────────────────
  {
    key: 'apprentice_first_hammer',
    slot: 'weapon',
    nameKo: '견습생의 첫 망치',
    region: '일반',
    tone: '일상',
    lore: '첫날엔 내 손등을 한 번 쳤다. 둘째 날엔 모루를 빗맞혔다.\n\n셋째 날에 강철을 똑바로 두드렸고, 스승이 옆에서 처음으로 꾸벅 졸았다. 망치 자루 끝엔 내 첫 자국이 한 줄 짧게 남았다.',
    art: `ornate fantasy weapon: small one-handed forge hammer, iron head with mild ash dusting, oak handle smoothed by apprentice grip, warm homely, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'porter_loyal_club',
    slot: 'weapon',
    nameKo: '짐꾼의 곤봉',
    region: '일반',
    tone: '위트',
    lore: '평생 두 번 휘둘렀다. 한 번은 들개, 한 번은 짐을 노리던 친구.\n\n친구는 그날 이후로 짐을 안 노렸다. 곤봉은 새벽마다 어김없이 내 옆구리에 끼워져 있고, 끝엔 길에서 묻힌 흙이 한 겹 굳었다.',
    art: `ornate fantasy weapon: short cudgel, knotted wood head, hide-rope grip, road-soot smudges, faintly comic bulk, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    ...
    region: '일반',
    tone: '영웅담',
    lore: '들녘 끝에서 다리가 한 번 떨렸다. 다음 순간엔 떨림이 사라졌다.\n\n사슴 한 마리에 마을 잔치가 한 번 섰다. 자루엔 첫 사냥의 핏자국이 옅게 남았고, 창 끝엔 풀 한 줄이 묶여 있다.',
    art: `ornate fantasy weapon: simple hunting spear, narrow leaf-shaped iron head, ash shaft, deer-leather wrap, proud feel, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    ...
    region: '일반',
    tone: '비애',
    lore: '형은 말이 없었다. 활도 같이 말이 없어서 우린 새벽 들녘에 같이 나갔다.\n\n형이 떠난 가을, 시위는 천천히 늘어졌다. 올봄에 다시 메었고, 활은 마당 기둥에 비스듬히 기대 있다. 시위 끝엔 형의 매듭이 그대로다.',
  ...
  {
    key: 'sister_paired_daggers',
    slot: 'weapon',
    nameKo: '쌍둥이 단검',
    region: '일반',
    tone: '비애',
    lore: '언니가 먼 길을 떠나며 두 자루를 다 내게 두고 갔다. 나는 한쪽을 옆구리에, 한쪽을 베개 옆에 둔다.\n\n새벽마다 베개 옆 단검을 한 번 만지고 길을 나선다. 자루엔 언니의 손때가 진하고, 칼끝엔 옛 매듭 한 가닥이 묶여 있다.',
  ...
  {
    key: 'lantern_lighter_pole',
    slot: 'weapon',
    nameKo: '저녁 등 점등봉',
    region: '일반',
    tone: '일상',
    lore: '첫날엔 두 집 건너 등 하나를 못 켰다. 다음 날엔 다 켰다.\n\n자루엔 켠 등 그림이 한 줄로 새겨진다. 손이 자루 끝에 닿게 된 봄부터 새 그림이 하나씩 더 들어서고, 봉 끝 갈고리엔 등 기름이 옅게 묻었다.',
  ...
  },
  {
    ...
    region: '일반',
    tone: '영웅담',
    lore: '봄비 사흘에 마을 지붕 절반이 무너질 뻔했다. 새벽 두 시에 첫 집 지붕에 올라갔다.\n\n그날 밤이 새기 전에 다섯 채를 다 고쳤다. 망치 머리는 못 자국으로 빽빽하고, 자루는 어깨에 메기 좋게 닳았다. 머리 옆엔 빗방울 자국이 가지런하다.',
  ...
  {
    key: 'beekeeper_smoke_cudgel',
    slot: 'weapon',
    nameKo: '양봉가의 연기 곤봉',
    region: '일반',
    tone: '위트',
    lore: '벌을 쫓는 데 쓴 적은 없다. 아이들이 벌통을 건드리려 할 때 한 번 흔들어 보인다.\n\n그 정도로 효과는 충분했다. 곤봉 끝 연기 통엔 늘 새 연기가 한 줌 채워져 있고, 자루엔 꿀 자국이 옅게 굳었다.',
  ...
  // ── C 대화·증언 6 ─────────────────────────────────────────────────
  {
    ...
    region: '서쪽 화산',
    tone: '수수께끼',
    lore: '한 사람 — 이게 도리깨다. 두 사람 — 종이다. 흔들면 둔한 소리 한 번, 맑은 종 소리 한 번이 같이 울린다. 잠 못 자는 대장장이가 들어 보더니 둘 다 맞는 모양이라 했고, 다시 화로 옆에 세워 두었다.',
  ...
  {
    key: 'haggler_tusk_dispute',
    slot: 'weapon',
    nameKo: '흥정꾼의 도끼',
    region: '오크 부락',
    tone: '위트',
    lore: '오늘 — 이 어금니, 우리 사촌 거. 어제 — 내 거. 그제 — 우리 족장 거. 누구 것이냐고 물으면 답이 매번 달랐다. 그러고는 늘 깔깔 웃었다. 흥정터 사람들도 따라 웃었고, 어금니는 자루에 그대로 박혀 있다.',
  ...
  {
    key: 'twin_witness_shortsword',
    slot: 'weapon',
    nameKo: '두 형제 짧은검',
    region: '일반',
    tone: '수수께끼',
    lore: '형 — 내가 먼저 들었다. 동생 — 내가 먼저 들었다. 자루엔 손바닥 자국이 두 개 진하게 박혀 있다. 둘 다 자기 자국이라 했고, 누구의 자국이 더 깊은지 한 번도 가려지지 않았다. 자루는 둘 사이 못에 똑바로 걸렸다.',
    art: `ornate fantasy weapon: short sword, plain steel blade, leather grip with two distinct deep palm impressions on opposite sides, modest mystery, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'ridge_echo_bow',
    slot: 'weapon',
    ...
    region: '고대 룬 산맥',
    tone: '수수께끼',
    lore: '산지기 — 한 발 쏘면 울림이 두 번 돌아온다. 측량가 — 첫 울림은 내 화살, 두 번째 울림은 누군가의 다른 화살. 두 번째 화살을 본 자는 없고, 산은 그날도 깊은 정적이다. 활자루엔 푸른 가루가 한 줄 묻어 있다.',
    art: `ornate fantasy weapon: short recurve bow, grey stonework limbs with faint glowing-blue rune cracks, bowstring of pale fiber, mysterious, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'court_jester_baton',
    slot: 'weapon',
    nameKo: '광대의 짧은 봉',
    region: '일반',
    tone: '위트',
    lore: '큰 광대 — 흔드는 건 내 몫. 작은 광대 — 굴리는 건 내 몫. 끝엔 방울이 두 개 달려 있다. 둘이 같이 무대에 오르면 봉 한 자루로 무대가 둘이었고, 박수도 두 배였다. 방울 옆엔 분장 가루가 옅게 묻어 있다.',
    art: `ornate fantasy weapon: short ornate baton with two small bells at the tip, painted stripes faded, leather wrap, playful theater feel, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    ...
    region: '일반',
    tone: '위트',
    lore: '둘째 — 한 발 쏘면 옷에 빨간 점 하나. 동네 아이 — 그래도 줄을 선다. 시위에 색실 매듭이 묶여 있어, 화살이 빨간 점을 한 번 그리고 갔다. 가게 앞엔 줄이 매일 늘었고, 옆엔 빨간 점이 묻은 옷이 한 더미 쌓였다.',
  ...
  // ── D 시·동요 6 ──────────────────────────────────────────────────
  {
    key: 'orphan_bokken_song',
    slot: 'weapon',
    nameKo: '도장 목검',
    region: '일반',
    tone: '담백',
    lore: '한 손은 위로\n두 손은 아래로\n자루 끝엔 작은 호 하나\n옆엔 졸업 줄 한 개\n새벽 마당에 발자국 한 줄\n어린 손이 자루 끝에 닿는 봄',
    art: `ornate fantasy weapon: simple wooden practice sword bokken, smooth oak with darkened sweat marks, small carved names along the grip, modest, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'tribal_drum_chant',
    slot: 'weapon',
    nameKo: '북소리 뼈 철퇴',
    region: '오크 부락',
    tone: '장엄',
  ...
  {
    key: 'fallen_choir_dirge',
    slot: 'weapon',
    nameKo: '합창단 단검',
    region: '타락천사',
    tone: '비애',
    lore: '깃 한 가닥\n바닥에 한 번\n칼날 옆에 한 번\n사제의 손에 한 번\n빈 신전에 한 번\n차가운 빛이 한 번\n메아리가 한 번',
    art: `ornate fantasy weapon: slim dagger, pale silver blade, two black feathers tied beside the guard with leather cord, white-cloth wrapped grip, mournful, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'ridge_keeper_round',
    slot: 'weapon',
    nameKo: '산지기의 정',
    region: '고대 룬 산맥',
    tone: '장엄',
    lore: '비탈에 한 번\n산울림 두 번\n돌가루 세 번\n다시 뭉치는 네 번\n푸른 균열 위에 다섯 번\n산지기의 손이 여섯 번\n산문이 일곱 번',
    art: `ornate fantasy weapon: heavy hammer-and-chisel mason tool, grey carved-stone head with faint glowing-blue rune cracks, iron-bound haft with stone-dust wear, monumental, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'harvest_field_chant_pick',
    slot: 'weapon',
    nameKo: '들녘 곡괭이',
    region: '일반',
    tone: '영웅담',
    lore: '땅 한 번\n허리 한 번\n자루 한 번\n돌 한 번\n새벽 한 번\n들녘 한 바퀴 한 번\n돌아온 발 한 번',
    art: `ornate fantasy weapon: short field pickaxe, iron head with soil stains, oak handle smoothed by grip from leaning, sturdy hearty mood, crafted equippable weapon game asset, ${STYLE}`,
  },

  // ── G 제문·봉헌문 5 ──────────────────────────────────────────────
  {
    key: 'priest_prayer_mace',
    slot: 'weapon',
    nameKo: '사제의 철퇴',
    region: '타락천사',
    tone: '수수께끼',
    lore: '빛이여, 한 획만 더 떠올라라. 자루엔 짧은 기도 한 줄이 새겨져 있고, 끝엔 한 글자 자리가 비었다. 깃을 줍는 아이가 손가락을 대 본 자리가 잠시 차게 식었고, 사제의 손이 닿으면 한 획이 잠깐 떠오른다.',
  ...
  {
    key: 'mountain_offering_chisel',
    slot: 'weapon',
    nameKo: '룬 학자의 정 단검',
    region: '고대 룬 산맥',
    tone: '장엄',
    lore: '산이여, 글자 한 칸만 내려라. 칼날 옆면에 푸른 글자 자국이 흐릿하게 배어 있다. 닦아도 다시 올라오고, 산문 곁에 세워 두면 한 달에 한 칸씩 글자가 더 길어진다. 자루엔 룬 가루가 옅게 묻어 있다.',
    art: `ornate fantasy weapon: slim dagger with chisel-flat tip, faint blue rune residue along blade edge, grey carved-stone hilt with one small rune, scholar tool feel, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'tribal_offering_axe',
    slot: 'weapon',
    nameKo: '봉헌 손도끼',
    region: '오크 부락',
    tone: '영웅담',
    lore: '족장이여, 첫 어금니를 받으소서. 도끼날 옆엔 어금니 한 자리가 비어 있다. 신참 전사가 자기 첫 사냥에서 그 자리를 채우고, 모닥불 옆에서 부락이 한 번 더 들끓는다. 도끼 등엔 어금니 가루가 한 줄 묻어 있다.',
  ...
  {
    key: 'forge_quench_offering',
    slot: 'weapon',
    nameKo: '화로 봉헌검',
    region: '서쪽 화산',
    tone: '장엄',
    lore: '화로여, 한 번만 더 식히소서. 끓는 강에 두 번 담그고 잿비 아래 한 번 두는 한손검. 자루엔 식히기 전 강철의 결이 그대로 남고, 칼날엔 강물의 김이 한 번 더 서린다. 칼끝엔 검은 모래 한 알이 박혀 있다.',
    art: `ornate fantasy weapon: one-handed sword, dark steel blade with three quench-line marks, ash-stained leather grip, faint heat haze, solemn forge mood, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'marsh_offering_spear',
    slot: 'weapon',
    nameKo: '늪 봉헌 작살',
    region: '늪지대',
    tone: '담백',
    lore: '늪이여, 한 자루만 더 받으소서. 마른 우물 옆에 세워진 짧은 작살. 자루엔 어부가 평생 받친 매듭이 세 개 묶여 있고, 작살 끝엔 새벽 안개가 한 번 더 내려앉는다. 등불 빛이 매듭 위에 한 줄 떨어진다.',
    art: `ornate fantasy weapon: short three-prong fishing spear, marsh-patina iron head, reed-wrapped shaft with three braided offering knots, lantern soot, solemn, crafted equippable weapon game asset, ${STYLE}`,
  },
  ...
  // ── B 서간·문서 4 ───────────────────────────────────────────────
  {
    ...
    region: '일반',
    tone: '담백',
    lore: '인계서. 전령용 짧은검 한 자루. 자루 끝 도장 옆에 새 전령이 채울 자리가 비어 있음. 봉지 끈은 두 번 베어 봤고, 길에서 사람은 베지 않았음. 보관: 사무실 못 위. 칼날 상태: 양호. 비고: 없음.',
  ...
  {
    key: 'shipbreaker_ledger_pick',
    slot: 'weapon',
    nameKo: '난파선 곡괭이',
    region: '일반',
    tone: '담백',
    lore: '장부. 짐꾼 한 명, 곡괭이 한 자루, 뒤집힌 배 한 척. 빼낸 못 한 자루 반, 쪼갠 판자 마흔 장. 마을 지붕 절반과 헛간 다섯 채가 그 판자로 덮였음. 바닷물 자국은 그대로 둠. 다음 점검: 가을 첫 풍랑.',
  ...
  {
    key: 'inkmaster_letter_blade',
    slot: 'weapon',
    nameKo: '필경사의 편지 가르개',
    region: '일반',
    tone: '수수께끼',
    lore: '서간. 가는 칼날에 다섯 글자가 새겨져 있음. 보낸 이는 마지막에 모두 태웠음. 책상 위에 가르개만 남았고, 그 옆엔 새 봉투 한 장이 칼끝 아래에 똑바로 놓여 있음. 봉투엔 답장 자국이 없음.',
    art: `ornate fantasy weapon: slender ornamental letter-opener-shaped short blade, ink-stained ivory grip, five tiny engraved characters along the spine, scholar tool, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    key: 'orc_quartermaster_axe',
    slot: 'weapon',
    nameKo: '오크 보급 솥 도끼',
    region: '오크 부락',
    tone: '위트',
    lore: '흥정 보고. 솥뚜껑 흠 자국 마흔, 천막 줄 자른 횟수 일곱, 잘못 친 솥 한 개. 흥정꾼의 웃음 — 횟수 셀 수 없음. 부락이 같이 웃은 횟수 — 거의 매번. 잃어버린 솥뚜껑 한 개는 다음 흥정에 한 번 더 찾는다.',
  ...
  // ── F 박물지·관찰록 3 ──────────────────────────────────────────────
  {
    key: 'cave_lantern_bow',
    slot: 'weapon',
    nameKo: '동굴 등 활',
    region: '고대 룬 산맥',
    tone: '수수께끼',
    lore: '관찰 하나. 짧은활 한 자루, 시위로 등 뚜껑을 한 번에 닫음.\n관찰 둘. 자루에 닫은 등 그림 일곱, 마지막 한 자리 비어 있음.\n관찰 셋. 마지막 등은 동굴 더 깊은 자리에 있음. 가루는 푸른빛으로 옅음.',
    art: `ornate fantasy weapon: short recurve bow, grey carved-stone limbs with seven small lantern marks engraved on the grip and one empty slot, faint glowing-blue rune dust, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    ...
    region: '서쪽 화산',
    tone: '기괴',
    lore: '관찰 하나. 곡괭이 끝에 식다 만 강철 부스러기가 자석처럼 늘 붙음.\n관찰 둘. 귀를 대면 그 부스러기가 옅게 으르렁댐.\n관찰 셋. 새 손이 자루를 들면 한 번 더 으르렁댐. 자루엔 잿비 자국 두 줄.',
    art: `ornate fantasy weapon: short volcano warpick, iron head with clinging steel-flake bits, ash-stained oak grip, heat shimmer aura, eerie volcanic mood, crafted equippable weapon game asset, ${STYLE}`,
  },
  {
    ...
    region: '늪지대',
    tone: '기괴',
    lore: '관찰 하나. 자루엔 손바닥 자국 두 개. 큰 손과 작은 손.\n관찰 둘. 등불을 가까이 대면 작은 손 자국 안쪽에 끈끈한 막이 한 번 흔들림.\n관찰 셋. 마른 우물 옆에 똑바로 세워짐. 창 끝엔 갈대 한 줄.',
