...
const WEAPONS: CatalogItem[] = [
  ...
  },
  {
    ...
    region: '오크 부락',
    tone: '일상',
    lore: '오크 부락 신호병이 매일 새벽 들고 나가던 곤봉. 끝의 뿔나팔로 교대를 알리고, 자루로는 헐거워진 천막 말뚝을 박았다. 부락의 하루가 이 곤봉 소리로 열리고 이 곤봉 소리로 닫혔다. 특별할 것 없는, 그저 부락의 하루다.',
  ...
  },
  {
    ...
    region: '고대 룬 산맥',
    tone: '기괴',
    lore: '날 한가운데가 룬의 결을 따라 길게 갈라진 장검. 그 틈을 들여다보면 칼 두께보다 한참 더 깊은 곳까지 보인다. 오래 들여다본 자는 거기서 무언가 마주 보고 있었다고 했고, 두 번 들여다본 자는 없다.',
  ...
  },
  {
    ...
    region: '타락천사',
    tone: '수수께끼',
    lore: '날이 물결처럼 굽이친 단검. 칼집을 열 때마다 검은 깃 한 올이 어디선가 떨어진다. 떨어진 깃을 차곡차곡 모아 둔 자가 어느 날 세어 보니, 단 한 번도 같은 수였던 적이 없었다. 더한 적도, 버린 적도 없는데.',
