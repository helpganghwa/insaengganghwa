...
export const CATALOG_V3: CatalogItem[] = [
  ...
  },
  {
    ...
    "wornDesc": "floor-length white-and-gold gown, softly draped long sleeves, a gold sash over one shoulder, a tiered ruffled hem with delicate gold edging, radiant and graceful",
    "wornDescMale": "floor-length white-and-gold ceremonial robe-coat, long draped sleeves, a gold sash across one shoulder, a gold-edged layered hem over white trousers, radiant and stately"
  },
  {
    ...
    "wornDesc": "knee-length blue-and-white knightly coat with gold trim, a short blue shoulder cape, a white chest gem, and silver plate greaves, trim and elegant",
    "wornDescMale": "knee-length blue-and-white knight's surcoat with gold trim, a short blue shoulder cape, a white chest gem, and silver plate greaves, bold and gallant"
  },
  {
    ...
    "wornDesc": "fitted white plate armor with gold trim reaching down to matching white greaves, a gold eight-pointed star on the chest, and white feathered wings at the shoulders, radiant and graceful",
    "wornDescMale": "full-body white plate armor with gold trim, a gold eight-pointed star on the broad chest, and towering white feathered wings at the shoulders, radiant and majestic"
  },
  {
    ...
    "wornDesc": "fitted dark steel plate armor with bronze engraved pauldrons and breastplate, a dark-red front tabard and hip drapes over dark plate greaves, polished and regal",
    "wornDescMale": "full-body dark steel plate armor with heavy bronze engraved pauldrons and breastplate, a dark-red front tabard and hip drapes, imposing and regal"
  },
  {
    ...
    "wornDesc": "silver-blue plate armor with a soft white fur collar, snowflake emblems on the pauldrons, matching silver-blue plate greaves, and a flowing pale-blue frost-patterned cape, elegant and cool",
    "wornDescMale": "silver-blue full plate armor with a white fur collar, snowflake emblems on broad pauldrons, and a long pale-blue frost-patterned cape, stalwart and cold"
  },
  {
    ...
    "wornDesc": "floor-length pale ice-blue robe with a white fur collar and shoulder trim, wide flowing sleeves, and delicate white frost patterns down the front, serene and lovely",
    "wornDescMale": "floor-length pale ice-blue robe with a white fur collar and shoulder trim, wide draped sleeves, and white frost patterns down the front over pale trousers, serene and dignified"
  },
  {
    ...
    "wornDesc": "strapless black knee-length dress with a big orange waist bow, ragged orange ruffle skirt layers, orange-striped stockings and buckled black boots, playful and cute",
    "wornDescMale": "black witch's frock coat with a large orange sash knot at the waist, ragged orange-layered coattails, orange-striped leggings and buckled black boots, roguish and sharp"
  },
  {
    ...
    "wornDesc": "hooded dark-green-and-black robe with ragged torn hems, a bone ribcage ornament across the chest and a small skull clasp, eerie and elegant",
    "wornDescMale": "hooded dark-green-and-black robe with ragged torn hems, a bone ribcage ornament across the broad chest and a skull clasp, eerie and grim"
  },
  {
    ...
    "wornDesc": "crimson bell-skirted dress with puffed shoulders, wide ruffled sleeve cuffs, black lace neckline trim and layered black ruffle skirt tiers, gorgeous and gothic",
    "wornDescMale": "crimson gothic tailcoat with structured shoulders, wide black-trimmed cuffs, a black lace jabot at the collar, and layered black-trimmed coattails over black trousers, dashing and gothic"
  },
  {
    ...
    "wornDesc": "knee-length royal-blue military coat with gold fringed epaulettes, twin rows of brass buttons joined by gold braid, and a gold waist sash over white trousers and polished black riding boots, crisp and elegant",
    "wornDescMale": "knee-length royal-blue military coat with gold fringed epaulettes, twin rows of brass buttons joined by gold braid, and a gold waist sash over white trousers and polished black riding boots, commanding and grand"
  },
  {
    ...
    "wornDesc": "floor-length crimson gown with a stiff upright flame collar, pointed shoulder pieces, and orange sun-and-flame emblems down the front, striking and beautiful",
    "wornDescMale": "floor-length crimson ceremonial coat with a stiff upright flame collar, pointed shoulder guards, and orange sun-and-flame emblems down the front over black trousers, striking and majestic"
  },
  {
    ...
    "wornDesc": "white-and-gold armored dress with a gold winged-bird breastplate, a knee-length white pleated skirt with gold hip plates, silver greaves, and a blue waist sash, valiant and beautiful",
    "wornDescMale": "white-and-gold battle armor with a gold winged-bird breastplate, a knee-length white pleated war-kilt with gold hip plates and a blue waist sash over armored greaves, valiant and mighty"
  },
  {
    ...
    "wornDesc": "white-and-gold plate armor with large gold feathered wings at the shoulders and a blue tabard bearing a gold cross, over white-and-gold plate greaves, radiant and graceful",
    "wornDescMale": "white-and-gold plate armor with large gold feathered wings at the broad shoulders and a blue tabard bearing a gold cross, over white-and-gold plate greaves, radiant and majestic"
  },
  {
    ...
    "wornDesc": "dark blue-grey dragon-scale armor with gold trim covering the torso down to matching scale greaves, a gold dragon-head chest emblem with glaring red eyes, and large rust-brown leathery dragon wings with horn-tipped ribs rising behind the shoulders, fierce and regal",
    "wornDescMale": "dark blue-grey dragon-scale armor with gold trim covering the torso down to matching scale greaves, a gold dragon-head chest emblem with glaring red eyes, and large rust-brown leathery dragon wings with horn-tipped ribs rising behind the broad shoulders, fierce and imposing"
  },
  {
    ...
    "wornDesc": "floor-length red-orange feathered gown with a crimson corset bodice, gold bead chains, a red-jeweled gold collar, and layered feather skirts, dazzling and beautiful",
    "wornDescMale": "red-orange feathered long coat with a fitted crimson breastplate-vest, gold bead chains, a red-jeweled gold collar, and layered feather coattails, dazzling and fiery"
  },
  {
    ...
    "wornDesc": "knee-length navy coat with a short shoulder capelet, gold constellation lines and stars, gold front buttons and a brown waist belt, over deep-navy leggings and brown boots, dreamy and elegant",
    "wornDescMale": "knee-length navy coat with a short shoulder cape, gold constellation lines and stars, gold front buttons and a brown waist belt, over deep-navy trousers and brown boots, mysterious and grand"
  },
  {
    ...
    "wornDesc": "layered sand-beige robes with a softly wrapped cowl shawl and a striped red-brown woven waist sash with a hanging end, graceful and worn",
    "wornDescMale": "layered sand-beige robes with a wrapped cowl and a striped red-brown woven waist sash with a hanging end, rugged and stoic"
  },
  {
    ...
    "wornDesc": "long deep-burgundy robe with gold trim, a draped red shoulder mantle, wide flowing sleeves with crest patches, and a sashed waist, refined and elegant",
    "wornDescMale": "long deep-burgundy robe with gold trim, a draped red shoulder mantle, wide sleeves with crest patches, and a sashed waist, learned and dignified"
  },
  {
    ...
    "wornDesc": "navy double-breasted blazer with gold buttons, a red-striped ribbon bow at the white collar, gold chest crest, and a navy pleated skirt, neat and cute",
    "wornDescMale": "navy double-breasted blazer with gold buttons, a red-striped necktie at the white collar, gold chest crest, and matching navy tailored trousers, neat and sharp"
  },
  {
    ...
    "wornDesc": "green hooded half-cape over brown leather chest armor, a diagonal strap across the chest, belt pouches, and a green tunic with fitted brown trousers and leather boots, nimble and spirited",
    "wornDescMale": "green hooded half-cape over brown leather chest armor, a diagonal strap across the chest, belt pouches, and a green tunic with fitted brown trousers and leather boots, rugged and ready"
  },
  {
