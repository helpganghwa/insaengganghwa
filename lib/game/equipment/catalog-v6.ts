...
export const CATALOG_V6: CatalogItem[] = [
  {
    ...
    region: '일반',
    tone: '수수께끼',
    lore: '금빛 보름달 하나를 구름 테에 끼워 자루에 얹었다. 달 속에는 절구를 찧는 토끼 그림자가 있다. 그림자는 한 번도 이쪽을 돌아본 적이 없는데, 완드를 오래 든 사람의 그림자만은 밤마다 조금씩 토끼를 닮아 간다고 한다.',
  ...
  },
  {
    ...
    region: '일반',
    tone: '위트',
    lore: '매끈하게 다듬은 흰 나무 절굿공이다. 결을 따라 달빛 같은 광이 흐르고, 휘두르면 떡 찧는 소리가 난다. 떡은 한 번도 나온 적이 없지만, 그 소리만은 달에서 나는 것과 똑같다고 달에 가 본 적 없는 이들이 입을 모은다.',
