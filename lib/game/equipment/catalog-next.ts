...
export const CATALOG_NEXT: CatalogItem[] = [
  ...
  {
    key: 'rune_guardian_warhammer',
    slot: 'weapon',
    nameKo: '수호의 룬 망치',
    region: '고대 룬 산맥',
    tone: '영웅담',
    lore: '룬 산맥의 산문을 지키던 한 보초가 자기 망치 양면에 보호의 룬을 한 글자씩 깊이 박아 둔 자리다. 그 망치를 한 번 두드릴 때마다 산문 안쪽으로 들어오던 걸음 하나가 한 박자 늦게 되돌아갔고, 자루의 못 자국은 그 보초가 매 새벽마다 한 번씩 다시 짚어 본 자리다.',
    art: 'heroic epic mountain rune ancient fantasy guardian warhammer weapon item icon, large pale stone hammer with two protective rune sigils carved on each face and a nail-marked haft, single inanimate game loot object on transparent background',
  },
  {
    key: 'fallen_white_feather_avenger',
    slot: 'weapon',
    nameKo: '복수의 흰 깃 검',
    region: '타락천사',
    tone: '영웅담',
    lore: '한 천사의 동료가 추락한 새벽에 자기 검의 crossguard 가운데에 그 동료의 마지막 흰 깃 한 가닥을 한 줄로 묶어 둔 자리다. 자루의 가시는 그가 그 새벽 이후로 자기 손을 떨지 않으려 한 번씩 더 박은 자리이고, 깃의 흰빛은 닦아도 한 번도 옅어지지 않았다.',
    art: 'heroic epic fallen angel divine avenger fantasy longsword weapon item icon, dark steel blade with a single white feather tied at the crossguard and a thorned grip, single inanimate game loot object on transparent background',
  },
  {
