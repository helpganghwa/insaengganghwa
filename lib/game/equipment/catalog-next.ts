...
export const CATALOG_NEXT: CatalogItem[] = [
  ...
  {
    key: 'marsh_widow_leather_satchel',
    slot: 'armor',
    nameKo: '과부의 가죽 가방',
    region: '늪지대',
    tone: '비애',
    lore: '늪의 한 과부가 자기 남편의 마지막 살림 한 가지를 평생 자기 어깨에 메고 다닌 가방이다. 가방의 단추는 그가 처음 묶은 자리에서 한 번도 풀린 적이 없고, 가방 안쪽은 그가 매일 그 자리를 한 번씩 짚어 본 자국으로 한 줄씩 더 패여 들어가 있다.',
    art: 'mournful sorrowful marsh swamp fantasy widow leather satchel armor item icon, dark green leather shoulder satchel with a single button and a worn leather strap, single inanimate game loot object on transparent background',
  },
  {
    key: 'orc_warlord_pauldron',
    slot: 'armor',
    nameKo: '워로드의 어깨갑',
    region: '오크 부락',
    tone: '전설',
    lore: '부락의 첫 워로드가 자기 첫 일곱 싸움에서 잡아 온 짐승의 송곳니를 자기 어깨갑 가장자리에 한 줄로 박아 둔 자리다. 어깨갑 가운데에 새겨진 룬은 부락 사람들이 그 워로드의 이름을 한 글자씩 더해 새긴 자리이고, 매달린 사슬은 그가 마지막 새벽까지 풀지 않은 줄 그대로다.',
    art: 'legendary mythic ancient orcish tribal warlord fantasy pauldron shoulder armor item icon, dark iron shoulder plate with ancient tribal rune carvings, tusk trophies along the rim, and a single hanging chain, single inanimate game loot object on transparent background',
  },
  {
  ...
  {
    key: 'common_pilgrim_cloak',
    slot: 'armor',
    nameKo: '순례자의 cloak',
    region: '일반',
    tone: '수수께끼',
    lore: '한 순례자가 자기 평생의 길을 한 줄로 자기 cloak의 안쪽에 한 마디씩 더 적어 둔 자리다. 가슴께에 매단 brass medallion은 그가 자기 길의 첫 자리에서 가져온 알 한 점인데, medallion이 한 번 따뜻해지는 새벽마다 그는 그날의 다음 자리를 한 줄 더 적었다.',
    art: 'mysterious cryptic fantasy traveling pilgrim cloak armor item icon, faded gray hooded cloak with a single small brass medallion at the collar, single inanimate game loot object on transparent background',
  },

  // ── batch 16: armor 네 번째 5종 ──
  {
    key: 'orc_widow_claw_hide',
    slot: 'armor',
    nameKo: '발톱의 가죽 가슴갑',
    region: '오크 부락',
    tone: '비애',
    lore: '부락의 한 과부가 자기 남편이 마지막 사냥에서 잡은 짐승의 발톱들을 자기 가슴갑 위에 한 줄로 묶어 두었다. 가슴을 가로지른 검은 띠는 그가 남편의 한 호흡을 한 번 더 안에 묶어 두려 한 자리이고, 그 띠 아래로 늘어진 발톱은 마지막 새벽까지 한 줄로 흔들렸다.',
    art: 'mournful sorrowful orcish tribal fantasy widow hide chest wrap armor item icon, brown leather chest vest with a diagonal black mourning band and dangling beast claws along the hem, single inanimate game loot object on transparent background',
  },
  {
  ...
  {
    key: 'orc_clown_warpaint_armband',
    slot: 'accessory',
    nameKo: '광대 페인트 armband',
    region: '오크 부락',
    tone: '위트',
    lore: '부락의 한 어린 오크가 자기 첫 자리에 한 번 더 못 들어간 새벽에 자기 armband 가운데에 한 줄로 자기 얼굴 페인트를 한 번 더 그대로 그어 두고, 그 양 옆에 한 송곳니씩 더 매달아 둔 자리다. 그 페인트 자국은 어린 오크가 자기 동무들 사이에서 한 번 더 자기 자리를 만들어 본 결이다.',
    art: 'humorous quirky orcish tribal fantasy clown warpaint leather armband accessory item icon, brown leather armband with a single painted comic face mark at the center and two small tooth and claw charms dangling on each side, single inanimate game loot object on transparent background',
  },
  {
  ...
  {
    key: 'volcano_large_spark_ring',
    slot: 'accessory',
    nameKo: '잉걸의 큰 ring',
    region: '서쪽 화산',
    tone: '희망',
    lore: '서쪽 화로의 한 어린 풀무지기가 자기 첫 새벽에 자기 화로에서 가져온 한 알의 큰 잉걸을 자기 손가락 둘레의 ring 가운데에 한 번 더 굳혀 박아 둔 자리다. 둘레의 가시는 그 잉걸이 ring 밖으로 한 번 더 떨어지지 않게 한 줄씩 풀무지기가 한 자리에 더 박아 둔 자국이다.',
    art: 'hopeful radiant warm volcanic forge fire fantasy large spark ring accessory item icon, brown band ring holding a single large orange ember gemstone at the center with small thorn details along the band, single inanimate game loot object on transparent background',
  },
  {
  ...
  {
    key: 'orc_warpaint_gold_diadem',
    slot: 'accessory',
    nameKo: '워페인트 황금 diadem',
    region: '오크 부락',
    tone: '화려',
    lore: '부락의 한 부족장이 자기 평생 자기 얼굴에 한 번 더 그어 둔 세 가지 색 워페인트를 자기 머리띠 가운데에 한 번 더 황금으로 굳혀 박아 둔 자리다. 가운데 박힌 빨간 보석은 부족장이 자기 첫 사냥에서 가져온 한 알이고, 양 옆 작은 보석은 그가 평생 더 잡은 자국이다.',
    art: 'ornate flamboyant gilded orcish tribal chief fantasy warpaint gold diadem accessory item icon, wide gold diadem band painted with three bright warpaint stripes and inlaid with red rubies along the rim, single inanimate game loot object on transparent background',
  },
  {
