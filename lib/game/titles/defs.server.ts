...
export const TITLE_SECRETS: TitleSecret[] = [
 ...
 },
 {
  ...
  cat: "추석",
  cond: "2026 추석 강화 대회 달토끼 장비 3등 안(아이템 하나면 충분)",
  diff: "한정"
 },
 {
  code: "chuseok26_moon2",
  cat: "추석",
  cond: "2026 추석 강화 대회 달토끼 장비 2등 안(아이템 하나면 충분)",
  diff: "한정"
 },
 {
  code: "chuseok26_moon1",
  cat: "추석",
  cond: "2026 추석 강화 대회 달토끼 장비 1등(아이템 하나면 충분)",
  diff: "한정"
 },
 {
  code: "chuseok26_flower3",
  cat: "추석",
  cond: "2026 추석 강화 대회 한복 장비 3등 안(아이템 하나면 충분)",
  diff: "한정"
 },
 {
  code: "chuseok26_flower2",
  cat: "추석",
  cond: "2026 추석 강화 대회 한복 장비 2등 안(아이템 하나면 충분)",
  diff: "한정"
 },
 {
