...
export const TITLE_SECRETS: TitleSecret[] = [
 ...
 },
 {
  ...
  cat: "이정표",
  cond: "처음으로 전투력 5,000,000 달성",
  diff: "한정"
 },
 {
  code: "first_combat5m_2",
  cat: "이정표",
  cond: "두 번째로 전투력 5,000,000 달성",
  diff: "한정"
 },
 {
  code: "first_combat5m_3",
  cat: "이정표",
  cond: "세 번째로 전투력 5,000,000 달성",
  diff: "한정"
 },
 {
  code: "first_combat10m_1",
  cat: "이정표",
  cond: "처음으로 전투력 10,000,000 달성",
  diff: "한정"
 },
 {
  code: "first_combat10m_2",
  cat: "이정표",
  cond: "두 번째로 전투력 10,000,000 달성",
  diff: "한정"
 },
 {
  code: "first_combat10m_3",
  cat: "이정표",
  cond: "세 번째로 전투력 10,000,000 달성",
  diff: "한정"
 },
 {
  code: "first_t20_1",
  cat: "이정표",
  cond: "처음으로 한 장비를 초월 20단계까지",
  diff: "한정"
 },
 {
  code: "first_t20_2",
  cat: "이정표",
  cond: "두 번째로 한 장비를 초월 20단계까지",
  diff: "한정"
 },
 {
  code: "first_t20_3",
  cat: "이정표",
  cond: "세 번째로 한 장비를 초월 20단계까지",
  diff: "한정"
 },
 {
  code: "first_t40_1",
  cat: "이정표",
  cond: "처음으로 한 장비를 초월 40단계까지",
  diff: "한정"
 },
 {
  code: "first_t40_2",
  cat: "이정표",
  cond: "두 번째로 한 장비를 초월 40단계까지",
  diff: "한정"
 },
 {
  code: "first_t40_3",
  cat: "이정표",
  cond: "세 번째로 한 장비를 초월 40단계까지",
  diff: "한정"
 },
 {
  code: "first_sum20k_1",
  cat: "이정표",
  cond: "처음으로 합산 강화 20,000 달성",
  diff: "한정"
 },
 {
  code: "first_sum20k_2",
  cat: "이정표",
  cond: "두 번째로 합산 강화 20,000 달성",
  diff: "한정"
 },
 {
  code: "first_sum20k_3",
  cat: "이정표",
  cond: "세 번째로 합산 강화 20,000 달성",
  diff: "한정"
 },
 {
  code: "first_sum30k_1",
  cat: "이정표",
  cond: "처음으로 합산 강화 30,000 달성",
  diff: "한정"
 },
 {
  code: "first_sum30k_2",
  cat: "이정표",
  cond: "두 번째로 합산 강화 30,000 달성",
  diff: "한정"
 },
 {
  code: "first_sum30k_3",
  cat: "이정표",
  cond: "세 번째로 합산 강화 30,000 달성",
  diff: "한정"
 }
] as const;
