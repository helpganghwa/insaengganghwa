...
/**
 * 최초 이정표 기록(2026-09-26, docs/TITLES.md) — 서버에서 이정표를 **처음 넘은 세 사람**을 순서대로 남긴다(금·은·동).
 ...
 *  - 소급: 배포 전에 이미 넘긴 사람은 scripts/first-milestones-backfill.ts가 로그 순서대로 먼저 넣는다(0218 → 소급 → 코드 배포).
