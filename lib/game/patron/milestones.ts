 ...
 *  C 250만~1,000만: 50만마다 💎10,000 + 📦300 (16구간)
 *    — 2026-09-04: 100만 단위가 너무 길다는 후원자 건의로 650만~1,000만을 50만 단위로 쪼갬(0190 — 기존
 *      700/800/900/1,000만 수령분 💎20,000은 새 표의 두 구간 합과 같아 짝 50만 구간을 지급됨으로 표시, 회수 없음).
