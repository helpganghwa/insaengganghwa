...
/**
 * §10 속성 교체 쿨타임 — **24시간**(최초 적용 무쿨, 잔여분 💎 단축 1💎=1분 표준).
 * 72h→24h(2026-07-28): 카운터픽 기회가 매일 2회(대난투 09:00·점령전 23:00)인데 쿨이 주기의
 * 3배라 수집 가치(아바타를 모아 상대에 맞추는 유일한 이득)가 대부분 잠겼다. 24h면 무과금도
 * 하루 1회는 새로 픽할 수 있고, 하루 두 이벤트를 모두 대응하려면 💎가 필요해 sink는 유지된다.
 * 풀 스킵 1,440💎(≈₩4.4~5.9k, 실지출 평균은 그 절반) — 반복 결제 가능한 가격대.
 */
export const RUNE_SWAP_COOLDOWN_MS = 24 * 3600_000;
