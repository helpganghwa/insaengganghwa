...
/**
 * 속성 적용 = **대표 아바타 그대로**(2026-07-28 확정 — 완전 흡수). 별도 지정·교체 쿨·💎 단축 없음:
 * 관리 대상을 하나로 줄여 UI 간섭을 제거했고, 전투에는 정산 시점(점령전 23:00·대난투 09:00)의
 * 대표 아바타 속성이 스냅샷으로 적용된다. 상대 속성은 비공개라 자유 교체로 인한 악용 여지가 적고,
 * 매일 자유롭게 갈아탈 수 있어 아바타를 많이 보유할수록 유리해진다(수집 가치 = 아바타 매출).
 */
