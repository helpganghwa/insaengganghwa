...
function subjectOf(male: boolean): string {
  return male
    ? 'a handsome bishonen — a young man in his early twenties (about 20-24) with a fresh youthful adult face that clearly reads as early twenties (past the teens): a SLENDER OVAL face with DELICATE refined features, a softly tapered chin (never wide, never rugged), smooth slim cheeks, LARGE expressive anime eyes as big relative to his face as a heroine\'s (the same eye-to-face proportion), a small nose and mouth, a TALL slim long-legged 7-heads-tall body; clearly male with a flat masculine chest and a masculine hairstyle'
    : 'a beautiful bishojo — a young woman in her early twenties (about 20-24) with a fresh youthful adult face that clearly reads as early twenties (past the teens, poised and clear-featured): a SLENDER OVAL face with DELICATE refined features, a softly tapered chin, smooth slim cheeks, LARGE expressive anime eyes with layered bright highlights, a small nose and mouth, a TALL slim long-legged 7-heads-tall body';
}
...
STYLE (EMPHASIZE STRONGLY): MODERN 2020s Japanese TV-anime character design — contemporary anime key-visual, smooth clean lineless cel-shading with soft shape edges and seamless color fills, bright vibrant saturated colors with refined modern color grading. EYES: large expressive anime eyes with MULTI-LAYERED gradient irises (a deep base tone, a lighter inner gradient and several small bright highlights — a complex modern iris, not one flat shine), long soft lashes. BODY & CLOTHING share the SAME stylization, line quality and shading as the face — slender natural anime body lines, clothing with natural fabric flow. The modern Japanese-anime look is the most important stylistic goal.
