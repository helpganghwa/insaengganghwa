...
export const GUILD_INTRO_MAX_LEN = 120; // 2026-09-16 유저 건의(플레이스토어 오픈 전 "뭐 하는 길드인지" 보여주기엔 60자 부족) — 60→120
...
// ── 거주 이동 (§5.5) ──
// 배치·집행관은 그 구역 거주자만 가능하고, 거주 이동은 인접 구역으로만 가능하다.
// 이동 쿨타임(6시간·보석 단축)은 2026-08-31 삭제 — 점령전 참여를 막는 마찰이었고, 인접 규칙만으로도
// 세력이 지도 위에서 이어지는 흐름은 유지된다(연속 인접 이동으로 어디든 도달 가능).
