...
// '합류'는 길드끼리 붙을 때만('A에 합류해') — '새로 합류한 이들'(길드원 가입) 같은 묘사는 동맹이 아니다(09-26).
const ALLIANCE = /합세|연합해|연합한|연합을|손잡|손을 잡|힘을 합|동맹|(?:에|와|과)\s?합류(?:해|하여|하며)/;
...
const TOPO = /조각|비지|별도의? 거점|떨어진 (?:곳|땅|거점|영토)|고립된? (?:영토|땅|거점|구역|섬)/;
/** 22 — 지역 석권 표현. */
