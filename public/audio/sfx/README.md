...
| `raid-block.webm` | 방어 | `stylized mobile game shield block, bright metallic clink, short, dry` |
| `raid-victory.webm` | 페이즈 돌파·승리 | `cheerful mobile game victory jingle, short bright triumphant fanfare` |
