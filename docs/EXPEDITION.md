...
| 💎 다이아만 | 20% | 15~35 |
| 📦+💎 둘 다 | 25% | 상자 3~4개 + 다이아 10~20 |

**희귀 롤(본상과 독립, 각각 별도 판정)**
...
- 지역 간 기본 수치 동일(§2 — 티어 스케일 없음). 희귀 롤 확률도 전 지역 동일.
- 시간 스케일(본상 수량에 적용): 1h=×0.15, 4h=×0.55, 8h=×1.0, 12h=×1.6, 24h=×3.4
  (24h 시간당 효율 최고 — 하루 1회 유저 배려). 희귀 롤 확률은 4h 미만 ×0.3, 그 외 동일.
