...
- **미션 슬롯**: 고정 슬롯에 서버가 **랜덤 미션(지역 × 난이도)**을 롤해서 올려둔다.
  - 슬롯 해금(2026-08-27 상향): 기본 1칸 · 슬롯2 = 파견 Lv.10 무료(≈2~4주) **또는** 💎1,000 ·
    슬롯3 = Lv.30 무료(≈2개월) **또는** 💎2,000 — 무료 해금을 느리게 두어 다이아 해금이 실질 경로(즉시완료 삭제로
    사라진 sink를 대신).
...
- **단축 없음**(2026-08-27 즉시완료 삭제): 1💎=1분 환산이면 24h 즉시완료 1,440💎로 아무도 안 쓰고 인상만 나빠 제거. sink는 슬롯 다이아 해금·유료 새로고침.
