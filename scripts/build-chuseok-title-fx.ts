...
const MOON: T[] = [
  { label: '신월', fx: 'newmoon', alt: '新月', rank: '3등', note: '기울어진 초승달이 숨 쉬듯 밝아질 때, 글자가 오른쪽부터 왼쪽으로 부드럽게 新月로 바뀌고 다음 숨에 같은 방향으로 신월로 돌아옵니다.' },
  { label: '반월', fx: 'halfmoon', alt: '半月', rank: '2등', note: '반달이 같은 박자로 半月로 바꿉니다. 초승달보다 조금 크고 밝습니다.' },
  { label: '만월', fx: 'fullmoon', alt: '滿月', rank: '1등', note: '금빛 보름달이 가장 크고 밝게 숨 쉬며 滿月로 바꿉니다.' },
];
const FLOWER: T[] = [
...
<div class="wrap">
  ...
  ${setBlock('달토끼 장비', '오른쪽의 달이 은은히 밝아질 때 글자가 오른쪽부터 왼쪽으로 한자로, 다음에 한글로', MOON)}
