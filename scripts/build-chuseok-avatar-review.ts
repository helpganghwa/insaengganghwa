...
<div class="wrap">
  <h1>${title}</h1>
  <p class="lead">실서버와 같은 생성 과정(장비 그림을 보고 AI가 설명을 조립한 뒤 Pixellab이 그림)으로 만든 시험 아바타 ${made}개입니다. 조합마다 입힌 장비 세 개를 아래에 두었습니다. ${SET === 8 ? '절굿공이만 다시 시험한 2개입니다. 양 끝이 두껍고 가운데로 갈수록 서서히 얇아지는 나무 막대기로 썼습니다.' : SET === 7 ? '절굿공이만 다시 시험한 2개입니다. 물건 이름 대신 양 끝에 같은 크기의 둥근 나무 덩이가 달린 곧은 자루로 썼습니다.' : SET === 6 ? '남성 한복을 저고리·배자·바지로, 절굿공이를 양 끝이 굵고 가운데가 잘록한 형태로 고친 뒤 다시 만든 4개입니다. 남성 한복 2개, 절굿공이 3개가 들어 있습니다.' : SET === 5 ? '절굿공이 비유를 없애고 남성 한복을 hanbok으로 명명한 뒤 다시 만든 4개입니다. 남성 한복 2개, 절굿공이 3개가 들어 있습니다.' : SET === 4 ? '착용 묘사를 고친 뒤 다시 만든 4개입니다. 남성 한복 2개, 절굿공이 3개, 여성 토끼 인형 옷 2개가 들어 있습니다.' : SET === 3 ? '확정 6종을 카탈로그 정본 그대로 입혔습니다. 한복 세트와 달토끼 세트는 남녀 완성형으로, 나머지는 교차 조합이며 한복 방어구는 남성에게 두 번 입혀 치마가 남성 한복으로 옮겨지는지 봅니다.' : SET === 2 ? '왕 · 무관 · 저승사자 · 선비 코스튬을 완성형으로 넣고, 새 방어구는 남녀로 한 번씩 입혔습니다.' : '방어구 세 종은 남녀로 한 번씩, 무기와 장신구는 고루 섞었습니다.'}</p>
