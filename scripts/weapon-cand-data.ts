...
export const CAND_DATA: CandData[] = [
  ...
  },
  {
    ...
    lore:
      '검은 덤불이 여러 겹으로 꼬여 자루가 되고, 꼭대기에서 진홍 한 송이가 벌어져 있다. ' +
      '늪을 건너려던 군세가 이 지팡이 하나에 막힌 적이 있다. 땅을 한 번 내리치자 발밑에서 ' +
      '가시덤불이 사람 키만큼 솟아, 앞줄은 물러설 자리조차 찾지 못했다. ' +
      '이듬해 그 자리는 늪에서 장미가 가장 많이 피는 들이 됐다.',
  },
];
