...
export const CAND_DATA: CandData[] = [
  ...
  },
  {
    ...
    lore:
      '검은 덤불을 여러 겹 꼬아 만든 자루에 잔가시가 빼곡하고, 꼭대기에서 진홍 한 송이가 벌어져 있다. ' +
      '늪에서는 이 꽃이 한 번에 한 사람만 알아본다고 했다. 주인이 쥐면 활짝 열리고, ' +
      '다른 손이 닿으면 그 자리에서 봉오리로 돌아간다. ' +
      '빼앗아 간 자들이 하나같이 시든 막대만 들고 돌아온 것도 그래서다.',
  },
];
