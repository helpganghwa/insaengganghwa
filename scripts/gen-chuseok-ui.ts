// ⚠ 2026-09-23: 결과 폴더(public/sprites/chuseok-ui)는 정본 선정 뒤 삭제됐다. 재실행하면 전부 새로(유료) 생성되니 돌리지 말 것.
/**
...
const CHAR_TAIL = ', a beautiful clean fantasy anime RPG gacha-game character sprite, bright and crisp, a single isolated figure on a plain flat empty background, large, pixel art';
...
const JOBS: Job[] = [
  ...
  // 6차(사용자 "다른 색감으로 여러 컨셉"): 팔레트를 달리한 배너 여섯
  { key: 'banner_o', w: 384, h: 128, noBg: false, prompt: 'wide banner background in warm amber and gold tones, a calm river at dusk reflecting a huge golden full moon, a small wooden boat, reeds on the bank, orange-gold sky fading to brown, fully filled edge-to-edge composition, no text, pixel art' },
  { key: 'banner_p', w: 384, h: 128, noBg: false, prompt: 'wide banner background in soft lavender and pink pastel tones, a pale full moon in a violet dawn sky, fields of silver grass swaying, fireflies, misty hills, gentle and dreamy, fully filled edge-to-edge composition, no text, pixel art' },
  { key: 'banner_q', w: 384, h: 128, noBg: false, prompt: 'wide banner background in jade green and teal tones, under the eaves of a Korean tiled roof with strings of dried persimmons hanging, a full moon glowing between the eaves and a dark teal night sky, fully filled edge-to-edge composition, no text, pixel art' },
  { key: 'banner_r', w: 384, h: 128, noBg: false, prompt: 'wide banner background in deep crimson and gold tones, a still life on red silk cloth with gold-leaf cloud patterns, a lacquered tray of white half-moon rice cakes, a brass candle holder, a round window with the full moon at the back, fully filled edge-to-edge composition, no text, pixel art' },
  { key: 'banner_s', w: 384, h: 128, noBg: false, prompt: 'wide banner background in ivory and warm brown tones, the inside of a hanok room looking out through a lattice paper window (changhoji) with a big full moon shining through the panes, a low wooden table with a teapot, soft warm light, fully filled edge-to-edge composition, no text, pixel art' },
  { key: 'banner_t', w: 384, h: 128, noBg: false, prompt: 'wide banner background in midnight blue and silver tones, a huge pale silver full moon above a sea of clouds, two white cranes flying across, scattered stars, elegant and quiet, fully filled edge-to-edge composition, no text, pixel art' },
  ...
  // 6차(09-22 밤): "한옥 마당과 감나무 외에는 다 별로 → 다시 달토끼 + 송편 컨셉". banner_c의 분위기(한옥 마당·감나무·등불·남색 밤하늘)를 유지하고
  // 달토끼를 넣되, 송편은 pixflux가 계속 틀리므로 장면은 빈 상/쟁반만 두고(no food) 객체 생성 송편 접시를 나중에 합성한다(UI 배경은 합성 허용).
  { key: 'banner_u', w: 384, h: 128, noBg: false, prompt: 'wide banner background of a traditional Korean hanok courtyard at night, a huge golden full moon low in the sky with the dark silhouette of a rabbit pounding rice cake with a pestle inside the moon, a persimmon tree with orange fruits on the left, stone wall, warm lantern light from a paper window, dark navy sky with stars, an empty low wooden table on the wooden porch at the bottom right with nothing on it, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'banner_v', w: 384, h: 128, noBg: false, prompt: 'wide banner background, a cute fluffy white rabbit wearing a small jade-green hanbok vest sitting on the wooden porch of a Korean hanok at night, looking up at a huge golden full moon, a persimmon branch with orange fruits hanging from the top left, warm paper-window light, dark navy starry sky, an empty low wooden table beside the rabbit with nothing on it, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'banner_w', w: 384, h: 128, noBg: false, prompt: 'wide banner background, a cute white rabbit pounding rice in a wooden mortar with a big wooden pestle in a Korean hanok courtyard at night, a huge golden full moon behind it, a persimmon tree with orange fruits, stone wall, paper lantern glow, dark navy starry sky, an empty wooden tray on the ground at the bottom left with nothing on it, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'banner_x', w: 384, h: 128, noBg: false, prompt: 'wide banner background, two cute white rabbits sitting side by side on a grassy hill at night gazing up at a huge golden full moon, the tiled roof of a Korean hanok and a persimmon tree in dark silhouette, fireflies, dark navy starry sky, an empty low wooden table at the bottom center with nothing on it, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'banner_y', w: 384, h: 128, noBg: false, prompt: 'wide banner background of a Korean hanok courtyard at night, a huge golden full moon with the dark silhouette of a rabbit and pestle inside it, a persimmon tree with orange fruits, a low wooden table on the porch holding a white dish of smooth plump half-moon shaped rice cakes in white and pink (Korean songpyeon), each a clean crescent half-moon with no pleats, warm lantern light, dark navy starry sky, fully filled edge-to-edge composition, no text, pixel art' },
  { key: 'sp_plate_a', w: 128, h: 128, noBg: true, mode: 'object', prompt: 'a small round white ceramic dish holding four smooth plump half-moon Korean songpyeon rice cakes, two pure white and two soft pink, no pleats, rounded surfaces, soft shading' + OBJ_TAIL },
  { key: 'sp_plate_b', w: 128, h: 128, noBg: true, mode: 'object', prompt: 'a low rectangular wooden tray with a neat pile of smooth plump half-moon Korean songpyeon rice cakes in pure white and soft pink, no pleats, rounded surfaces, a small sprig of green pine needles' + OBJ_TAIL },
  // 7차(09-22 밤): "달토끼 컨셉은 좋은데 송편은 빼고 절구 + 달토끼, 한옥 마당과 감나무와 다른 색감으로". 송편 없음(no food), 색감을 장면마다 다르게.
  { key: 'moon_a', w: 384, h: 128, noBg: false, prompt: 'wide banner background in warm amber and gold tones, a cute white rabbit pounding rice cake in a wooden mortar with a big wooden pestle, standing in a golden reed field at dusk, a huge orange-gold full moon rising behind it, silhouetted mountains, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'moon_b', w: 384, h: 128, noBg: false, prompt: 'wide banner background in deep crimson and gold tones, a cute white rabbit pounding a wooden mortar with a pestle in front of a huge golden full moon, red silk sky with gold-leaf cloud patterns, elegant and opulent, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'moon_c', w: 384, h: 128, noBg: false, prompt: 'wide banner background in jade green and teal tones, a cute white rabbit pounding rice cake in a wooden mortar with a pestle under a huge pale gold full moon, teal night sky with soft clouds, the edge of a Korean tiled roof and a hanging lantern at one side, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'moon_d', w: 384, h: 128, noBg: false, prompt: 'wide banner background in soft lavender and pink pastel tones, a cute white rabbit pounding a wooden mortar with a pestle on a hill of silver grass, a huge pale full moon in a violet dawn sky, drifting pink petals, gentle and dreamy, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'moon_e', w: 384, h: 128, noBg: false, prompt: 'wide banner background in midnight blue and silver tones, a huge pale silver full moon filling the right side with the dark silhouette of a rabbit pounding a mortar with a pestle inside it, a sea of clouds below, scattered stars, elegant and quiet, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'moon_f', w: 384, h: 128, noBg: false, prompt: 'wide banner background in ivory and warm brown tones, a cute white rabbit pounding rice cake in a wooden mortar on the wooden porch of a hanok, a huge full moon glowing through a lattice paper window behind it, warm soft light, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'moon_g', w: 384, h: 128, noBg: false, prompt: 'wide banner background in deep plum purple and gold tones, a cute white rabbit pounding a wooden mortar with a pestle standing on top of a huge golden full moon, gold clouds and sparkling stars around, fully filled edge-to-edge composition, no text, no food, pixel art' },
  // 8차(09-22 밤): "자줏빛 달 위의 토끼(moon_g)가 마음에 드는데 절구와 방망이 퀄리티가 별로" → 같은 장면을 절구·방망이 묘사를 강하게 해 3장 재생성 +
  // 토끼 없는 배경(moon_gbg)에 객체 생성 토끼(rabbit_obj_a/b)를 합성하는 판.
  { key: 'moon_g2', w: 384, h: 128, noBg: false, prompt: 'wide banner background in deep plum purple and gold tones, a cute white rabbit standing on top of a huge golden full moon, pounding a large wooden mortar made of vertical wooden staves bound by two dark iron bands, holding a big smooth wooden pestle upright in both paws, the mortar and pestle drawn clearly and crisply, gold clouds and sparkling stars around, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'moon_g3', w: 384, h: 128, noBg: false, prompt: 'wide banner background in deep plum purple and gold tones, a cute white rabbit standing on top of a huge golden full moon, pounding a large wooden mortar made of vertical wooden staves bound by two dark iron bands, holding a big smooth wooden pestle upright in both paws, the mortar and pestle drawn clearly and crisply, gold clouds and sparkling stars around, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'moon_g4', w: 384, h: 128, noBg: false, prompt: 'wide banner background in deep plum purple and gold tones, a cute white rabbit standing on top of a huge golden full moon beside a large sturdy wooden mortar with iron bands, lifting a long smooth wooden pestle high with both paws about to pound, the mortar and pestle large and clearly readable, gold clouds and sparkling stars around, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'moon_gbg', w: 384, h: 128, noBg: false, prompt: 'wide banner background in deep plum purple and gold tones, a huge golden full moon in the center with a flat empty top edge, gold clouds and sparkling stars around, a small crescent moon at each side, no rabbit, no animals, no objects, fully filled edge-to-edge composition, no text, pixel art' },
  { key: 'rabbit_obj_a', w: 128, h: 128, noBg: true, mode: 'object', prompt: 'a cute chubby white rabbit standing upright, pounding a large wooden mortar made of vertical wooden staves bound by two dark iron bands, holding a big smooth wooden pestle upright in both paws, side view' + CHAR_TAIL },
  { key: 'rabbit_obj_b', w: 128, h: 128, noBg: true, mode: 'object', prompt: 'a cute chubby white rabbit standing upright beside a large sturdy wooden mortar with iron bands, lifting a long smooth wooden pestle high with both paws, side view' + CHAR_TAIL },
  // 9차(09-22 밤): "절구는 돌절구 느낌이 나야지, 한국 떡 절구처럼" → 나무 절구 대신 회색 화강암 돌절구(두껍고 둥근 통, 거친 돌결) + 긴 나무 방망이.
  { key: 'moon_h1', w: 384, h: 128, noBg: false, prompt: 'wide banner background in deep plum purple and gold tones, a cute white rabbit standing on top of a huge golden full moon, pounding rice cake in a large round grey granite stone mortar (Korean dol-jeolgu), a heavy thick-walled cylindrical stone bowl with a rough speckled stone texture and a slightly wider rim, holding a long smooth wooden pestle upright in both paws, the stone mortar and pestle drawn clearly and crisply, gold clouds and sparkling stars around, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'moon_h2', w: 384, h: 128, noBg: false, prompt: 'wide banner background in deep plum purple and gold tones, a cute white rabbit standing on top of a huge golden full moon, pounding rice cake in a large round grey granite stone mortar (Korean dol-jeolgu), a heavy thick-walled cylindrical stone bowl with a rough speckled stone texture and a slightly wider rim, holding a long smooth wooden pestle upright in both paws, the stone mortar and pestle drawn clearly and crisply, gold clouds and sparkling stars around, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'moon_h3', w: 384, h: 128, noBg: false, prompt: 'wide banner background in deep plum purple and gold tones, a cute white rabbit standing on top of a huge golden full moon beside a big heavy grey granite stone mortar (Korean dol-jeolgu), a thick round stone bowl with a rough speckled texture, lifting a long wooden pestle high with both paws about to pound, the stone mortar large and clearly readable, gold clouds and sparkling stars around, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'moon_h4', w: 384, h: 128, noBg: false, prompt: 'wide banner background in deep plum purple and gold tones, a cute white rabbit standing on top of a huge golden full moon beside a big heavy grey granite stone mortar (Korean dol-jeolgu), a thick round stone bowl with a rough speckled texture, lifting a long wooden pestle high with both paws about to pound, the stone mortar large and clearly readable, gold clouds and sparkling stars around, fully filled edge-to-edge composition, no text, no food, pixel art' },
  { key: 'rabbit_obj_c', w: 128, h: 128, noBg: true, mode: 'object', prompt: 'a cute chubby white rabbit standing upright beside a big heavy grey granite stone mortar (Korean dol-jeolgu), a thick round stone bowl with a rough speckled texture, lifting a long smooth wooden pestle high with both paws, side view' + CHAR_TAIL },
];
