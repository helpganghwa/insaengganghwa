/**
 * 오픈 직전 테스트 데이터 청소(2026-08-21, 1회성) — 8/24 KST 10:18·10:28 발화(vercel.json
 * '18,28 1 24 8 *' — 멱등이라 2틱=재시도, 분은 guild-emblem-retry(:03~:16,:23~:26 점유
 * 가능)·5분 주기 크론들과 겹치지 않게 선정). 봉인 기간(8/21~24 10:00) 심사·어드민 테스트
 * 흔적을 서버 오픈(10:30) 전에 자동 제거한다.
 *
