...
export default async function ProbabilityPage() {
  ...
  return (
    <main className="mx-auto min-h-dvh w-full max-w-[390px] bg-white px-4 py-5 text-zinc-900 dark:bg-black dark:text-zinc-50">
      ...
      <Sec n="6" title="룬 (아바타 속성)" id="rune">
        <P>
          아바타를 생성하면 <b>룬 1개</b>가 함께 지급됩니다. 룬에는 무기·방어구·장신구 세 줄의
          속성이 새겨지며, 각 줄은 <b>권역</b>(여섯 지역 중 하나)과 <b>수치</b>(0~50)를 가집니다.
          한 번 새겨진 속성은 바뀌지 않습니다.
        </P>
        <Table head={['항목', '확률']}>
          <tr className="border-t border-zinc-100 dark:border-zinc-900">
            <Td>줄의 권역 (천사·왕국·오크·늪·화산·신전)</Td>
            <Td>각 1/6 (약 16.7%)</Td>
          </tr>
          <tr className="border-t border-zinc-100 dark:border-zinc-900">
            <Td>줄의 수치 (0~50 정수)</Td>
        ...
        <P>
          같은 권역 줄은 수치가 합산됩니다(한 룬의 권역당 최대 150). 상성은{' '}
          <b>천사→왕국→오크→늪→화산→신전→천사</b> 순환으로, 각 권역은 바로 다음 권역에만 강합니다.
          효과는 유저 간 전투(점령전·대난투)와 레이드에만 적용되며, 많이 생성해도 상대를 이길 기대
          확률이 평균적으로 높아지지는 않습니다 — 상대에 맞춰 <b>고를 수 있는 폭</b>이 넓어질
          뿐입니다.
        </P>
      </Sec>
