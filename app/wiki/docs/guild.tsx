  ...
  return (
    <>
      ...
      <UL>
        ...
        <LI>
          문양은 결성할 때 한 장이 무료다. 이후로는 뽑을 때마다{' '}
      ...
      <H2 id="join">가입</H2>
      <P>
        가입 방식은 자유와 승인 둘이다. 자유면 누르는 즉시 들어가고, 승인이면 신청이 걸린 뒤 가입 관리
        권한자가 받거나 물린다. 어느 쪽이든 정원이 차 있으면 못 들어간다.
      </P>
      <P>
      ...
      <H2 id="leave">탈퇴</H2>
      <P>
        길드원은 언제든 나간다. 나가는 순간 맡고 있던 집행관 자리와 아직 치르지 않은 배치가 함께
        풀린다.
      </P>
      <Warn>
      ...
      <P>
        길드장은 길드원이 남아 있는 동안 탈퇴가 막힌다. 자리를 넘기거나 해산해야 나간다. 혼자 남은
        상태에서 탈퇴하면 그대로 해산된다.
      </P>
      ...
      <Warn>
        해산하면 보유 구역이 전부 중립으로 풀리고 세금 풀은 사라진다. 문양과 길드 기록도 함께 지워지고
        되돌릴 방법은 없다.
      </Warn>
      <P>
        길드장이 오래 접속하지 않고 자리를 넘겨받을 사람도 없으면 길드는 자동으로 해산된다. 이때는
        전원에게 해산 우편이 간다. 판정 기준은 <DocLink slug="guild-roles">길드 권한</DocLink>에 있다.
      </P>
      <P>
