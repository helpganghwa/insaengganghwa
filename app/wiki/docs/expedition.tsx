  ...
  return (
    <>
      ...
      <UL>
        ...
        <LI>소요 시간은 2시간 · 4시간 · 8시간 · 12시간.</LI>
        <LI>슬롯마다 하루에 한 번 보낼 수 있다(자정 기준). 보상은 짧은 파견도 하루치에 가깝게 나오고, 오래 걸릴수록 조금 더 많다.</LI>
        <LI>파견 경험치는 파견이 열릴 때 시간별 구간 안에서 정해져 카드에 표시된다(길수록 조금 더 많다).</LI>
        <LI>보상을 수령한 슬롯은 그날은 “오늘 완료”로 남고, 다음 날 자정이 지나면 새 파견이 생긴다.</LI>
      </UL>
