  ...
  return (
    <>
      ...
      <UL>
        ...
        <LI>
          미션마다 <b>필요 강화 합</b>이 붙는다. 아바타를 만들 때 입힌 장비 세 개의 현재 강화 레벨을 더한
          값이 그 이상인 아바타만 보낼 수 있고, 필요 강화 합이 높을수록 보상 배율이 커진다(상한 없음).
        </LI>
        <LI>
          필요 강화 합은 내가 가진 아바타 중 가장 높은 강화 합을 기준으로 정해진다 — 강한 장비로 만든
          아바타가 있을수록 더 큰 보상의 미션이 나온다. 1번 슬롯에는 늘 낮은 조건의 미션이 뜬다.
        </LI>
      </UL>
