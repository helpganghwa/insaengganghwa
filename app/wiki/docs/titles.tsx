...
export default function Doc() {
  return (
    <>
      ...
      <H2 id="rep">대표 칭호</H2>
      <P>
        대표는 한 번에 하나만 단다. 목록에서 활성 칭호를 눌러 장착하고 같은 자리에서 해제한다.
        아무것도 달지 않아도 된다.
      </P>
      <P>
        대표로 건 칭호는 헤더와 프로필, 채팅, 자랑 카드와 공유 카드에 같이 나온다. 조건부 칭호를
      ...
      <P>
        칭호를 많이 모으는 것 자체가 조건인 칭호도 있다. 전체 발견 수를 보는 것과 히든만 세는 것이
        따로 있고, 기준 개수는 나와 있지 않다.
      </P>
