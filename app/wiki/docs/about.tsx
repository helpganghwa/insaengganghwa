...
export const meta: WikiDocMeta = {
  ...
  cat: '시작',
  title: '인생강화란',
  summary: '기다릴수록 확률이 오르는 방치형 강화 RPG. 처음이라면 여기부터.',
  sections: [
  ...
  return (
    <>
      ...
      <P>
        ...
        공시치까지 차오르고, 다 차면 거기서 멈춘다. 결과는 강화 카드를 눌러 수령하는 순간
        나온다. 시간이 다 찬 뒤로는 언제 눌러도 확률이 같아서, 화면을 붙들고 있는 쪽과 자고
      ...
      <H2 id="day">하루의 리듬</H2>
      <P>
        날짜 경계는 한국 시간 자정이다. 출석·일일 보급·레이드
