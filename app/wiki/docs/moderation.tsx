...
export default function Doc() {
  return (
    <>
      ...
      />
      <P>
        버그 악용과 기타는 짧은 설명을 같이 적는다. 무엇을 어떻게 했는지가 없으면 운영이 확인할
        근거가 없다.
      </P>
      ...
      <Note>
        신고 내용과 신고자는 운영에만 보인다. 신고당한 사람은 누가 신고했는지 알 수 없다.
      </Note>

      <H2 id="process">처리 절차</H2>
      <P>
        신고를 넣으면 운영자가 확인하고 사유에 맞는 조치를 한다. 신고가 쌓였다고 제재가 자동으로
        걸리지는 않고, 근거 없는 장난 신고는 기각된다.
      </P>
      <P>
        전체·길드 채팅은 한 메시지에 신고가 여러 건 모이면 먼저 가려진다. 귓속말은 가려지지 않는다.
      </P>
      ...
      <P>
        길드 이름은 결성할 때 정하고 나면 길드장도 못 바꾼다. 부적절한 이름은 운영이 알린 뒤 문의로
        새 이름을 받아 바꿔 준다.
      </P>
