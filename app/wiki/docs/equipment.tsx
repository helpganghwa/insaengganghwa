...
export default function Doc() {
  return (
    <>
      ...
      <P>
        보유 장비는 종류마다 하나다. 같은 장비가 또 나와도 개수가 늘지 않고, 두 번째부터는 그 장비의{' '}
        <DocLink slug="transcend">초월</DocLink> 진행도로 들어간다.
      </P>
      <P>
        같은 장비를 수치별로 여러 개 모아 둘 수는 없다. 장비 하나에 적힌 강화 수치와 초월 단계가 그
        장비의 전부다.
      </P>
      <Note>
        장비를 없애는 수단은 없다. 분해나 판매가 없고 다른 장비를 재료로 쓰는 절차도 없다. 한 번 얻은
        장비는 계정에 계속 남는다.
      </Note>

      <H2 id="equip">장착과 교체</H2>
      <P>
        부위마다 하나씩 장착한다. 같은 부위에 다른 장비를 장착하면 먼저 있던 것이 자동으로 해제되고,
        해제된 장비는 그대로 인벤토리에 남는다. 해제만 하고 부위를 비워 둘 수도 있다.
      </P>
      <P>
        장착이 정하는 것은 겉모습이다. 프로필과 아바타, 자랑 카드에 나오는 세트가 지금 장착한 셋이다.
      </P>
      ...
      <P>
        상자에서 빠진 아이템은 그 뒤로 보급에서 나오지 않고, 확률 공시의 활성 아이템 목록에서도
        빠진다.
      </P>
      <P>
        이미 가진 장비는 그대로 남는다. 강화도 걸리고 전투력에도 계속 들어가지만, 중복이 더 들어올 길이
