  ...
  return (
    <>
      ...
      <UL>
        ...
        <LI>
          순위표의 <b>공격 · 방어</b> 숫자는 시도 횟수가 아니라 <b>성공 횟수</b>다. 공격 성공은 내가 쓰러뜨린 수,
          방어 성공은 맞고도 버텨낸 수이며 탈락한 마지막 피격은 방어 성공에 세지 않는다. 탈락한 라운드와 나를
          쓰러뜨린 상대도 함께 기록된다.
        </LI>
      </UL>
      <Note>
        전투력이 낮아도 공격과 방어 지정이 늦게 오면 상위권까지 살아남을 수 있다. 예를 들어 다섯 번 공격해 처치가
        없고 한 번 맞은 것이 탈락 피격이라면, 실제 전투와 별개로 순위표에는 공격 0 · 방어 0으로 보인다.
      </Note>
      ...
      <UL>
        ...
        <LI>
          전체 전투의 라운드 기록은 <b>마지막 {fmtInt(MELEE_REPLAY_ROUNDS)}라운드</b>만 남긴다. 그 이전 전투는 재생에
          나오지 않지만, 순위표의 공격·방어 성공 수와 내 전투 기록에는 전부 반영되어 있다.
        </LI>
