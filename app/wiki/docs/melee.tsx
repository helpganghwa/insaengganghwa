    ...
    <>
      ...
      <UL>
        <LI>
          ...
          이 있고 최근 30일 안에 접속했다면 매일 자동으로 참가된다. 따로 신청하지 않는다.
          <Fn n={1} />
        </LI>
      ...
      <UL>
        ...
        <LI>같은 수치가 상점의 대난투 포인트로도 쌓인다.</LI>
      ...
      <FnList notes={['장비가 하나도 없어 전투력이 0이거나, 30일 넘게 접속하지 않았다면 그 회차 참가자에서 제외된다. 다시 접속하면 다음 회차부터 참가한다.']} />
    </>
  );
}
