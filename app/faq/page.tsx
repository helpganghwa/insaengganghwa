...
const FAQS: { q: string; a: string; body?: ReactNode }[] = [
  {
    q: '인생강화는 어떤 게임인가요?',
    a: '장비를 강화 슬롯에 올려두면 시간이 흐를수록 성공 확률이 올라가는 방치형 강화 RPG예요. 게임을 켜두지 않아도 진행되니, 일상을 보내다 돌아와 결과를 수령하고 다음 강화를 걸어두면 됩니다. 무기·방어구·장신구를 모아 강화·초월하고, 레이드와 대난투에서 다른 대장장이들과 겨루세요.',
  },
  {
    q: '무료로 즐길 수 있나요?',
