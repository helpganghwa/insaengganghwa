  ...
  return (
    <div className="mt-2">
      <textarea
        ...
        className="w-full resize-none rounded-lg border border-zinc-300 bg-white px-2.5 py-2 text-sm outline-none focus:border-zinc-400 dark:border-zinc-700 dark:bg-zinc-900"
      />
