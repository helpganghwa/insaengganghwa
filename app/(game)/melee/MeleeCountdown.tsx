  ...
  return (
    <div className="relative flex h-full flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center gap-2 px-6 text-center">
        <div className="text-2xl font-extrabold tracking-wide text-white text-pixel-outline">대난투</div>
      ...
      <div className="relative z-10 px-6 pb-6 text-center text-[11px] leading-relaxed text-zinc-300 text-pixel-outline">
