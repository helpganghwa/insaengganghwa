...
import { GameRatingSplash } from '@/components/GameRatingSplash';
...
export default async function GameLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <HeaderStatsProvider>
      ...
      <div data-app-shell className="fixed inset-0 mx-auto flex max-w-[390px] flex-col pc-column-edge">
        <SpritePreloader />
        <SfxUnlock />
        ...
        {/* 게임물 등급 표시(§33) — 진입(세션1회)·온라인 1시간 반복 모두 헤더 슬라이드 토스트 4초. 포털 렌더. */}
        <GameRatingSplash />
