...
export function WorldTicker({ entries }: { entries: WorldEventEntry[] }) {
  ...
  return (
    <Link prefetch={false}
      ...
      className="sticky top-0 z-20 block border-b border-zinc-200 bg-white px-4 py-1 active:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 dark:active:bg-zinc-900"
    >
