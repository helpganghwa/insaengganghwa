...
import { listPublishedAnnouncementSummaries, getUserPollVotes } from '@/lib/game/announcement';
...
export default async function HomePage() {
  ...
  const [worldFeed, announcements, tutState, chgStatus, todayStats] = userId
    ? await Promise.all([
        ...
        withTimeout(listPublishedAnnouncementSummaries(30, serverId), 2000, 'home.ann').catch(() => []),
