              ...
              {items.map((c) => {
                ...
                return (
                  <Link
                    key={c.id}
                    href={`/me/codex/${c.id}`}
                    className="grid aspect-square grid-rows-[1.5rem_minmax(0,1fr)_1.5rem] rounded-xl border-2 border-zinc-200 bg-white p-1 text-center dark:border-zinc-800 dark:bg-zinc-950"
                  >
