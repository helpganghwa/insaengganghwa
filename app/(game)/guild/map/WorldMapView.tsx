      ...
      <div className="relative aspect-square w-full shrink-0 overflow-hidden border-b border-zinc-800 bg-zinc-950">
        ...
        {hasFog && (
          ...
          >
            ...
            <rect width="100" height="100" fill="rgb(22, 26, 38)" opacity={0.93} mask="url(#wmfog-mask)" />
            <rect width="100" height="100" fill="rgb(94, 104, 128)" opacity={0.22} mask="url(#wmfog-mask)" filter="url(#wmfog-wobble)" />
          </svg>
        )}
        {zones.map((z) => {
